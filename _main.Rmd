...
1. Foster and nurture your scientific motivation! I understand that working with animal poop is probably not the way you thought you life is going to be. However, think about the beautiful things we can find there! All the diversity and ecological interactions that reflect so many facets of life…

2. Read and try to stay up to date with the scientific literature. There are a list of papers that are mandatory to read as part of being in the lab (Google docs folder I shared with you when you join the lab). In addition, start creating a mendeley/EndNote/Zotero list of papers of interest that you read (or at least skim in depth) and can use for your publications and presentations
...
4. Place the new culture in the 25°C and the old culture in the tall incubator
...
1. Make small YPSS plates of specimen at least 1 week prior to liquid culturing
2. Autoclave and UV components - mason jars, mason jar tops
3. Under the hood, ethanol rim of mason jar and jar top, then place jar top on mason jar and tape the top and jar together
4. Pour about 150ml of PDB in through the top opening
5. Ethanol sides of culture plate, then place  plate in the top opening
6. Cover top fully with aluminum foil, then tape the foil down and write the specimen name, date, type of liquid media, and initials on the tape

<!--chapter:end:02-Isolation.Rmd-->

# Poop Extractions

## Fecal Pellet Storage: 
...
15. Centrifuge at 16,000 x g for 2 min. Carefully place the MB Spin Column into a new 1.5 mL Elution Tube.
...
<!--chapter:end:03-Poop_Extractions.Rmd-->
...
<!--chapter:end:04-WaterExtraction.Rmd-->

# Soil Extractions

## Detailed Procedure from DNeasy Powersoil Extraction kit
...
<!--chapter:end:06-HMW_Extraction.Rmd-->

# PCR Protocols 

## DreamTaq (Any Primers)

- **Location in thermocyclers**
  1. Dependent on primers 
  
### Protocol Mixture (DreamTaq)
...
### Protocol Conditions (DreamTaq)

**DEPENDENT ON PRIMERS**

## ITS Metabarcoding (ITS1-F/ITS2)

- **Location in thermocyclers**
  1. WALLE: TLAB/ITSBC
  2. EVA: ITS1/ITSBC

### Protocol Mixture (ITS1-F/ITS2)

***With sample number (n)***

| Reagent        | Per sample (Microliters) | Total Mix (Microliters) | Order      |
|----------------|--------------------------|-------------------------|------------|
| Buffer         |                        8 |                     8*n |            |
| dNTP's         |                        1 |                     1*n |            |
...
### Protocol Conditions (ITS1-F/ITS2)
...
### Protocol Mixture (LSU)

| Reagents       | Per sample (Microliters) | Total Mix (Microliters) | Order      |
|----------------|--------------------------|-------------------------|------------|
| Buffer         |                      2.5 |                   2.5*n |            |
| dNTP's         |                      0.5 |                   0.5*n |            |
...
### Protocol Mixture (EXOSAP)

| Reagent | Per sample (Microliters) | Total Mix per sample (Microliters) |
|---------|--------------------------|------------------------------------|
| ExoSAP  |                        2 |                                  2 |
| DNA     |                        5 |                                  1 |

### Protocol Conditions (EXOSAP)
...
<!--chapter:end:07-PCR.Rmd-->

# A basic roadmap of the cluster

## How to log in

<!--chapter:end:08-Cluster.Rmd-->

# Safety and PPE

(No accidents allowed till I finish this chapter. LPC 10/14/2022)

<!--chapter:end:09-Safety_and_PPE.Rmd-->
...
<!--chapter:end:11-CommunityEnrichment.Rmd-->
